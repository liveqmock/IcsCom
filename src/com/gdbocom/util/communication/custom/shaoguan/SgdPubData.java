 ...
 *
 */
public class SgdPubData extends Transation {
    ...
    public static String telNum2telType(String telNum){
        ...
        if(telNum.matches("1((3[4-9])|47|(5[0-27-9])|(8[78]))\\d{8}")){//移动
            return SgdPubData.contactMobile;
        }else if(telNum.matches("1((3[0-2])|(5[56])|(8[56]))\\d{8}")){//联通
            return SgdPubData.contactUnicom;
        }else if(telNum.matches("1(([35]3)|(8[09]))\\d{8}")){//电信
            return SgdPubData.contactTianyi;
        }else{
            return SgdPubData.contactNone;
        }
    }
    ...
    public static Map getSignBusiness(){
        ...
        //一期上线没有报备移动签约，先行注释
        //business.put(SgdPubData.businessOfMobile, "移动签约");
        business.put(SgdPubData.businessOfUnicom, "联通签约");
        //business.put(SgdPubData.businessOfTele, "电信签约");
        business.put(SgdPubData.businessOfProvTv, "省有线电视签约");
        business.put(SgdPubData.businessOfCityTv,
                "市有线电视（珠江数码）签约");
        //business.put(SgdPubData.businessOfGas, "燃气签约");
        business.put(SgdPubData.businessOfWater, "水费签约");
        //排除电费划扣
        //business.put(SgdPubData.businessOfElectricity, "电费签约");
        return business;
    }
    ...
    public static Map getBCusId(){
        ...
        /* 初始化企业代码 */
        bCusId.put(SgdPubData.businessOfWater       , "190426853");
        bCusId.put(SgdPubData.businessOfMobile      , "618652334");
        bCusId.put(SgdPubData.businessOfUnicom      , "890346651");
        bCusId.put(SgdPubData.businessOfTele        , "0");
        bCusId.put(SgdPubData.businessOfGas         , "0");
        bCusId.put(SgdPubData.businessOfElectricity , "0");
        bCusId.put(SgdPubData.businessOfProvTv      , "726482280");
        bCusId.put(SgdPubData.businessOfCityTv      , "190498531");
    ...
    public static Map getTBusTp(){
        ...
        /* 初始化业务类型 */
        tBusTp.put(SgdPubData.businessOfWater       , "00201");
        tBusTp.put(SgdPubData.businessOfMobile      , "00403");
        tBusTp.put(SgdPubData.businessOfUnicom      , "00500");
        tBusTp.put(SgdPubData.businessOfTele        , "0");
        tBusTp.put(SgdPubData.businessOfGas         , "0");
        tBusTp.put(SgdPubData.businessOfElectricity , "0");
        tBusTp.put(SgdPubData.businessOfProvTv      , "01000");
        tBusTp.put(SgdPubData.businessOfCityTv      , "91001");
